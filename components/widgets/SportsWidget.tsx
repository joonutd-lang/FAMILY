    ...
    <CardContent className="h-full">
      <div className="flex items-start justify-between gap-3">
        <div>
          <div className="flex items-center gap-2">
            <Star className="h-4 w-4 text-black/60 dark:text-white/60" />
            <div className="text-sm font-semibold">Sports</div>
          </div>
          <div className="mt-1 text-xs text-black/60 dark:text-white/60">Pick favorite teams. Scores + next games.</div>
        </div>
      ...
      <div className="mt-3 rounded-2xl border border-black/10 bg-white/60 p-3 dark:bg-black/30">
        <div className="flex items-center justify-between gap-2">
          <div className="text-xs font-medium text-black/60 dark:text-white/60">Favorite teams</div>
        ...
        {favoriteTeamIds.length === 0 ? (
          ...
          <div className="mt-3 space-y-2">
            {(widgetData ?? []).map((item) => {
              ...
              return (
                <div key={team.id} className="rounded-2xl border border-black/10 bg-white/70 p-3 dark:bg-black/20">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <div className="mt-2 text-sm">
                        ...
                        <span className="text-black/60 dark:text-white/60">final</span>
                      </div>
                    </div>
                    <UiBadge variant="default" className="bg-black/5 dark:bg-white/10">
                      Next
                    </UiBadge>
                  </div>
